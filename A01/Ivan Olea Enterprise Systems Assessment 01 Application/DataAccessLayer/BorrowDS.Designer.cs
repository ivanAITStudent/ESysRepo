...
ORDER BY TabBorrow.BorrowDate DESC";
            ...
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        TabBorrow.BID, TabBorrow.BorrowDate, TabBorrow.ActualReturnDate, TabBorrow.MediaID, TabMedia.Title, TabBorrow.UID, TabUser.UserName, 
                         TabBorrow.ReturnDate, TabBorrow.LateFee
FROM            TabBorrow INNER JOIN
                         TabMedia ON TabBorrow.MediaID = TabMedia.MediaID INNER JOIN
                         TabUser ON TabBorrow.UID = TabUser.UID
ORDER BY TabBorrow.BorrowDate DESC, TabBorrow.ActualReturnDate DESC";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[2].Connection = this.Connection;
...
ORDER BY TabBorrow.BorrowDate DESC";
            ...
            this._commandCollection[3].CommandText = @"SELECT        TabBorrow.UID, TabBorrow.BID, TabBorrow.MediaID, TabMedia.Title, TabUser.UserName, TabBorrow.BorrowDate, TabBorrow.ReturnDate, 
                         TabBorrow.ActualReturnDate, TabBorrow.LateFee
FROM            TabBorrow INNER JOIN
                         TabMedia ON TabBorrow.MediaID = TabMedia.MediaID INNER JOIN
                         TabUser ON TabBorrow.UID = TabUser.UID
...
ORDER BY TabBorrow.UID";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByAllBorrows(BorrowDS.UserBorrowHistoryDataTableDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual BorrowDS.UserBorrowHistoryDataTableDataTable GetDataByAllBorrows() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            BorrowDS.UserBorrowHistoryDataTableDataTable dataTable = new BorrowDS.UserBorrowHistoryDataTableDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
